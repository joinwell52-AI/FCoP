...
| 17 | **FCoP Grew a Project Tree / FCoP 跑出了项目树** | [GitHub English](essays/from-mini-game-to-project-tree.en.md) · [GitHub 中文](essays/from-mini-game-to-project-tree.md) · [Evidence archive](essays/from-mini-game-to-project-tree-evidence/INDEX.md) | A CodeFlowMu + Grid Runner dogfood field note: `parent`, `thread_key`, Phase dispatch, and `CHILD_TASKS_OPEN` combined into a project tree; a failed archive and PM drawing the tree in chat were the recognition moment. Conclusion points to additive proposed `spec/0003-project-tree-protocol.md`. |
