<!--
============================================================
CSDN publication of essay 06 — Chinese full version
Source of truth on GitHub:
  https://github.com/joinwell52-AI/FCoP/blob/main/essays/what-agents-say-about-fcop.md

Recommended CSDN UI metadata:
  Title (主标题):     直接问 agent 它怎么看 FCoP——它说出了我们没让它说的话
...
这次 dogfood 完全照着 [英文 Tetris 案例教程](https://github.com/joinwell52-AI/FCoP/blob/main/docs/tutorials/tetris-solo-to-duo.en.md)（[中文译本](https://github.com/joinwell52-AI/FCoP/blob/main/docs/tutorials/tetris-solo-to-duo.zh.md)）走——一个 Cursor 用户装 `fcop-mcp` 0.7.2，跑 `init_solo(role_code="ME", lang="en")`，做出单文件的 `Nebula Stack` Tetris 复刻，用 `create_custom_team(force=True)` 切成 2 人队，让 PLANNER 和 CODER 合作做创意变种。
...
- [`evidence/tasks/`](https://github.com/joinwell52-AI/FCoP/tree/main/docs/tutorials/assets/tetris-en/evidence/tasks) 与 [`evidence/reports/`](https://github.com/joinwell52-AI/FCoP/tree/main/docs/tutorials/assets/tetris-en/evidence/reports) —— 完整 TASK / REPORT 链，共 14 份 markdown
...
**仓库（唯一真相，MIT 许可）：** https://github.com/joinwell52-AI/FCoP
**`fcop-mcp` 在 PyPI：** https://pypi.org/project/fcop-mcp/
**学术引用：** https://doi.org/10.5281/zenodo.19886036

如果你在自己的环境里跑了 FCoP 看到了什么意外的现象，欢迎来 [`essays/`](https://github.com/joinwell52-AI/FCoP/tree/main/essays) 提 issue 或 PR。这个协议的演进方式就是现场报告的累加。
