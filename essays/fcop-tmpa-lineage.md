...
- FCoP 规范 · [`codeflow-core.mdc`](../spec/codeflow-core.mdc)
...
**署名**：这篇 essay 的写作本身就是 FCoP 主张的那种协作——agent 升华原则，人类识别并落成文件。文本最终由 CodeFlow 团队修订、署名、发布。
