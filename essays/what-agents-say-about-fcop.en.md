...
**Keywords**: FCoP, agent endorsement, Cursor agents, PLANNER, CODER, protocol self-report, RLHF tension, role lock, sub-agent boundary, Rule 0.a.1, Rule 1, append-only history, ADMIN dialect, "Start work" "Inspection", true positive role-switch, agent product review
...
- [`evidence/tasks/`](https://github.com/joinwell52-AI/FCoP/tree/main/docs/tutorials/assets/tetris-en/evidence/tasks) and [`evidence/reports/`](https://github.com/joinwell52-AI/FCoP/tree/main/docs/tutorials/assets/tetris-en/evidence/reports) — full TASK / REPORT chain (ADMIN→ME, ADMIN→PLANNER, PLANNER→CODER, CODER→PLANNER, PLANNER→ADMIN), 14 markdown files
- [`games/nebula-stack.html`](https://github.com/joinwell52-AI/FCoP/blob/main/docs/tutorials/assets/tetris-en/games/nebula-stack.html) (33 KB, ME's solo Tetris) and [`games/comet-loom.html`](https://github.com/joinwell52-AI/FCoP/blob/main/docs/tutorials/assets/tetris-en/games/comet-loom.html) (42 KB, CODER's variant after PLANNER's rework brief)
- 22 dogfood screenshots from install through the final interviews, including the cover screenshot ([`fcop-team-planner-6.png`](https://raw.githubusercontent.com/joinwell52-AI/FCoP/main/docs/tutorials/assets/tetris-en/fcop-team-planner-6.png)) showing the eight `role-switch` evidence files surfaced by `fcop_check()`
