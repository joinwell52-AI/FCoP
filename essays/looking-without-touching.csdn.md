...
- **三层语义执行链完整规范**：[FCoP-semantic-execution-chain.md](https://github.com/joinwell52-AI/FCoP/blob/main/adr/FCoP-semantic-execution-chain.md)
- **ADR-0030 · 能力边界定义**：[ADR-0030](https://github.com/joinwell52-AI/FCoP/blob/main/adr/ADR-0030-capability-governance-boundary.md)
- **ADR-0031 · 治理告警层**：[ADR-0031](https://github.com/joinwell52-AI/FCoP/blob/main/adr/ADR-0031-governance-alert-layer.md)
- **ADR-0032 · fcop_audit 协议检视**：[ADR-0032](https://github.com/joinwell52-AI/FCoP/blob/main/adr/ADR-0032-fcop-audit-protocol-inspection.md)
- **《为什么协议要保持简短》**：同系列文章,讲协议不让自己生长的另一面
...
> **标签建议**：`AI Agent` `LLM` `协议设计` `软件架构` `DevOps` `多智能体` `FCoP`
>
> **专栏建议**：AI 工程实践 / 多 Agent 协作 / 软件架构设计
