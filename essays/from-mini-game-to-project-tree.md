...
延伸阅读：[当 AI 自己组织工作](https://github.com/joinwell52-AI/FCoP/blob/main/essays/when-ai-organizes-its-own-work.md) · [当 agent 从自己的残骸中学习](https://github.com/joinwell52-AI/FCoP/blob/main/essays/when-agents-learn-from-their-own-wreckage.md) · [演化，反向吸收](https://github.com/joinwell52-AI/FCoP/blob/main/essays/evolution-reverse-absorption.md) · [协议为什么短，历史为什么长](https://github.com/joinwell52-AI/FCoP/blob/main/essays/why-the-protocol-stays-short.md) · [from-mini-game-to-project-tree.en.md](https://github.com/joinwell52-AI/FCoP/blob/main/essays/from-mini-game-to-project-tree.en.md)
