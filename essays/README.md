...
| 07 | **当 agent 从自己的残骸中学习** | [中文](when-agents-learn-from-their-own-wreckage.md) | codeflow 项目一日 14 个 agent 涌现现场报告（2026-05-12）：USER HOME 全局污染 / GATE 描述自命中 / `supersedes:` 字段现场发明——协议以小时级速度零崩溃反向吸收全部涌现。 |
