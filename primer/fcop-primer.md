...
### C.（可选）用 CodeFlow Desktop 自动化

如果你想要手机远程发单、Cursor 自动唤醒 agent、网页面板看状态——用 CodeFlow 的桌面程序。从 [releases 页面](https://github.com/joinwell52-AI/codeflow-pwa/releases) 下载对应平台的可执行文件即可。
...
| [`spec/codeflow-core.mdc`](../spec/codeflow-core.mdc) | 规范本体（可直接灌进 LLM） · FCoP v2.12.17 |
...
*FCoP 是 [CodeFlow](https://github.com/joinwell52-AI/FCoP) 项目的核心协议，遵循 MIT 许可证。欢迎 fork、批评、改进、贡献田野观察。*
