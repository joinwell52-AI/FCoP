...
> Rules version: \2.0.0\ · Protocol commentary version: \1.8.0\n
---
...
**Version**: `fcop_rules_version: 2.0.0`（见 frontmatter）。升级时 `fcop`
...
> **v1.0 Capabilities pointer**（v1.7.0 起）：v1.0 新增 Rule 9（4 子段
> 对应 REVIEW / Boundary / Failure / Event 4 抽象）的详细 commentary
> 留 v1.0 final 版本补完；现阶段 agent 想用这些能力，参考：
>
> - `spec/schemas/{review,boundary,failure,event}.schema.json` — 字段层面
> - `adr/ADR-0017..0020` — 决策与理由
> - `docs/getting-started.md` 末尾"v1.0 新能力速查" — 5 行示例
>
> v1.7.0+: detailed commentary for Rule 9 sub-sections (REVIEW /
> Boundary / Failure / Event) is deferred to v1.0 final. For now,
> consult `spec/schemas/`, ADR-0017..0020, and the "v1.0 capability
> cheatsheet" appendix in `docs/getting-started.en.md`.
