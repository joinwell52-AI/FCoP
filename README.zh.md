...
<p align="center">
  ...
  <a href="CHANGELOG.md">
    <img src="https://img.shields.io/badge/%E5%8F%91%E5%B8%83-1.1.0-brightgreen?style=flat-square" alt="1.1.0" />
  </a>
...
- **当前发布**：`v1.1.0`（2026-05-10）——v1.1 新增 Agent.layer 治理合约、Task.risk_level、Review.needs_human、HumanApproval、Skill.tools[]。完全向后兼容。详见 [CHANGELOG](CHANGELOG.md)。
