...
| 05 | **教程：贪吃蛇 solo 转 2 人——FCoP-MCP 让 AI 团队有纪律** | [GitHub 中文](docs/tutorials/snake-solo-to-duo.zh.md) · [CSDN 中文](https://blog.csdn.net/m0_51507544/article/details/160603953) | 唯一一篇**教程性质**的文章。45 分钟跟着真实 dogfood 走一遍：让 AI 替你装 fcop-mcp，单 agent 写一只能跑的贪吃蛇，切 2 人团队后 PLANNER 设计 + CODER 实现原创主题游戏。中间还碰上一次 PLANNER 越界冒充 CODER 的彩蛋——从越界发生到协议留证、ADMIN 截停、ISSUE 归档全程记录在案。附 18 张真实截图 + 完整 TASK / REPORT / ISSUE 落盘记录。 |
