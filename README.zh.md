...
| **理解协议契约** — 合规实现 MUST 做什么 | [`spec/fcop-runtime-protocol-v1.0.md`](spec/fcop-runtime-protocol-v1.0.md) |
| **理解决策背后的原因** — 每个设计的考量 | [`adr/`](adr/) — 从 [ADR-0015](adr/ADR-0015-fcop-1.0-ai-os-protocol-charter.md) 开始 |
| **发布说明** — v1.0.0 改了什么 | [`docs/releases/1.0.0.md`](docs/releases/1.0.0.md) |
...
- **当前发布**：`v1.0.0`（2026-05-09）——七大核心概念已固化为 v1.x 稳定标准。详见[发布说明](docs/releases/1.0.0.md)。
- **规范性文件**：[`spec/fcop-runtime-protocol-v1.0.md`](spec/fcop-runtime-protocol-v1.0.md) · 机器可读契约见 [`spec/schemas/`](spec/schemas/)
