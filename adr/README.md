...
| **ADR-0037** *(file deleted)* | ~~Custody & Handoff~~ — **Rejected by RFC 2026-05-21**（custody 不能作为协议层；思想保留为 [NOTE-custody-is-not-a-layer.md](./NOTE-custody-is-not-a-layer.md)；决策叙事见 [essays/the-day-we-almost-added-custody.md](../essays/the-day-we-almost-added-custody.md)） | **Withdrawn** | 2026-05-21 |
